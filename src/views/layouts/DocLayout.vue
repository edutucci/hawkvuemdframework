<template>
  ...
  >
        ...
        <h-app-toolbar-container>
          ...
          <h-app-toolbar-action>
            <!-- <h-input
              ...
              style="width: 350px"
            >
              <template v-slot:itemoption="itemoption" >
                ...
                >
                  ...
                  <div class="row align-items-center"
                    ...
                    :key="index"
                  >
                    <div @click="goURL(topic.url)"
                      class="col-auto text-body2 h-pr-sm text-right border-right border-gray bg-gray200 border-bottom -border-gray"
                      style="width: 130px;line-height: 40px;">
    ...
    <template v-slot:footer>
      <div class="flex justify-center align-items-center bg-primary text-white"
        style="height: 60px"
      >
