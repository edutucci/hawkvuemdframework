...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'input', component: () => import('../views/pages/input/input.vue') },
      ...
      { path: 'htmltable', component: () => import('../views/pages/table/htmlTable.vue') },
  ...
  {
    path: '/test',
    component: () => import('../views/pages/tests/input/inputfield.vue'),
  },
];
